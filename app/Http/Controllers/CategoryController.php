...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $image->storeAs('public/products', $category->id . '.' . $image->getClientOriginalExtension());
            $category->image = 'storage/products/' . $category->id . '.' . $image->getClientOriginalExtension();
            $category->save();
        }
